...
MPUs = 1 #Setting the number of used MPUs
...
while tmp < 1000: #while tmp
    ...
    for MPU in range(MPUs):
        ...
        print('X rot: ' + str(compfx_ac[MPU] - compfx_0[MPU]))
        print('Y rot: ' + str(compfy_ac[MPU] - compfy_0[MPU]))
        print('Z rot: ' + str(gyrointz_ac[MPU] - gyrointz_0[MPU]))
